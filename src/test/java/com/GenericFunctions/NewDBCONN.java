...
//public class db;
//public class NewDBCONN extends GenericMethods {
////imp	
...
//		   
//		   
//    	   try { if(db.trim().equals("xcelerate")) {
////  			   dt = (DataSource)ic.lookup("jdbc:sqlserver://sa-igmsqlx.solarsystem.ioh.co.za");
////  			   } else if(db.trim().equals("xcelerate_UAT")) 
////  			   { dt = (DataSource) ic.lookup("jdbc:sqlserver://172.21.91.5"); } 
////  		   return dt;} 
