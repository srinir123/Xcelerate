		...
		// Create object of Property file
					...
					Session session = Session.getDefaultInstance(props,
							...
							new javax.mail.Authenticator() {
								...
								return new PasswordAuthentication("srinivas.repalas@gmail.com", "sairam$123");
					...
					try {
						...
						message.setFrom(new InternetAddress("srinivas.repalas@gmail.com"));
			 
						// Set the recipient address
						message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("srinivas.repalas@gmail.com"));
