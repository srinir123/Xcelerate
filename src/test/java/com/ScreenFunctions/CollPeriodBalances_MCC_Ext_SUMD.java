...
public class CollPeriodBalances_MCC_Ext_SUMD extends GenericMethods{
	...
	public static void CollPeriodBalances_MCC_Ext_SUMD(int i, int j) throws Exception 
    ...
    String Agreement_Name=getData("Agreement_Name","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Dropd_Agreement.sendKeys(Agreement_Name);
		waitForElement(Dropd_BucketID);
		
	    String BucketID=getData("BucketID","CollPeriodBalances_MCC_Ext_SUMD",i,j);
	    ...
	    String AccountHolder=getData("AccountHolder","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Edi_AccountHolder.sendKeys(AccountHolder);
		
	    String AccountNumber=getData("AccountNumber","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Edi_AccountNumber.sendKeys(AccountNumber);

		String Branchcode=getData("Branchcode","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Edi_Branchcode.sendKeys(Branchcode);

		String BankAccType=getData("BankAccType","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Dropd_BankAccType.sendKeys(BankAccType);

		String Amount=getData("Amount","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Edi_Amount.sendKeys(Amount);

		String TransRef=getData("TransRef","CollPeriodBalances_MCC_Ext_SUMD",i,j);

		Edi_TransRef.sendKeys(TransRef);

		String IntRef=getData("IntRef","CollPeriodBalances_MCC_Ext_SUMD",i,j);
