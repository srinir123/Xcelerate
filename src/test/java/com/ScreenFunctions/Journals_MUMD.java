...
public class Journals_MUMD extends GenericMethods{
	...
	public static void Journals_MUMD(int i) throws Exception 
	...
	String Entity_Name=getData("Entity_Name","Journals_MUMD",i);
    ...
    String Agreement_Name=getData("Agreement_Name","Journals_MUMD",i);

		Dropd_Agreement.sendKeys(Agreement_Name);
		waitForElement(Dropd_BucketID);
		
	    String BucketID=getData("BucketID","Journals_MUMD",i);
		...
		String DebitAmount=getData("DebitAmount","Journals_MUMD",i);

		Edi_DebitAmount.sendKeys(DebitAmount);
		
	    String Description=getData("Description","Journals_MUMD",i);

		Edi_Description.sendKeys(Description);
		
	    String BucketID2=getData("BucketID2","Journals_MUMD",i);
		
		Edi_BucketID2.sendKeys(BucketID2);
	    
	    String Amount2=getData("Amount2","Journals_MUMD",i);
		
		Edi_Amount2.sendKeys(Amount2);
		
	    String Description2=getData("Description2","Journals_MUMD",i);
