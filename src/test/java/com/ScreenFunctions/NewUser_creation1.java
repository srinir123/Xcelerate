...
public class NewUser_creation1 extends GenericMethods{
	...
	@FindBy(how=How.XPATH,using="//*[text()='siri308']")
	...
	public static <performDBLCLICK> void NewUser_creation1() throws Exception
	{   
        ...
        String Title=getData("Title","NewUser_creation",2);

        Dropd_Title.sendKeys(Title);
        LogEvent("pass","Data entered sucessfully for the field Title");
        
        String FirstName=getData("FirstName","NewUser_creation",2);

		Edi_FirstName.sendKeys(FirstName);

        String Surname=getData("Surname","NewUser_creation",2);

		Edi_Surname.sendKeys(Surname);

        String Designation=getData("Designation","NewUser_creation",2);

		Edi_Designation.sendKeys(Designation);

        String IDNumber=getData("IDNumber","NewUser_creation",2);

		Edi_IDNumber.sendKeys(IDNumber);

        String Telephone=getData("Telephone","NewUser_creation",2);

		Edi_Telephone.sendKeys(Telephone);

        String MobilePhone=getData("MobilePhone","NewUser_creation",2);

		Edi_MobilePhone.sendKeys(MobilePhone);

        String Fax=getData("Fax","NewUser_creation",2);

		Edi_Fax.sendKeys(Fax);

        String EMailAddress=getData("EMailAddress","NewUser_creation",2);

		Edi_EMailAddress.sendKeys(EMailAddress);

        String Messanger=getData("Messanger","NewUser_creation",2);

		Dropd_Messanger.sendKeys(Messanger);
		
        String PositionID=getData("PositionID","NewUser_creation",2);

	    Dropd_PositionID.sendKeys(PositionID);

        String EntityAddressID=getData("EntityAddressID","NewUser_creation",2);
