...
public class CollectionImport_Ext_SUMD extends GenericMethods{
	...
	public static void CollectionImport_Ext_SUMD(int i, int j) throws Exception 
	{  
	   ...
	   String Agreement_Name=getData("Agreement_Name","CollectionImport_Ext_SUMD",i,j);

	    Dropd_Agreement.sendKeys(Agreement_Name);
	
		waitForElement(Dropd_BucketID);
		
		String BucketID=getData("BucketID","CollectionImport_Ext_SUMD",i,j);
