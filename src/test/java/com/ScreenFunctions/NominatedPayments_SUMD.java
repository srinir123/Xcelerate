...
public class NominatedPayments_SUMD extends GenericMethods{
	...
	public static void NominatedPayments_SUMD(int i, int j) throws Exception 
	...
	String Entity_Name=getData("Entity_Name","NominatedPayments_SUMD",i,j);
    ...
    String Agreement_Name=getData("Agreement_Name","NominatedPayments_SUMD",i,j);

		Dropd_Agreement.sendKeys(Agreement_Name);
		waitForElement(Dropd_BucketID);
		
	    String BucketID=getData("BucketID","NominatedPayments_SUMD",i,j);
		...
		String TransactionRef=getData("TransactionRef","NominatedPayments_SUMD",i,j);

		Edi_transactionref.sendKeys(TransactionRef);
		
	    String Amount=getData("Amount","NominatedPayments_SUMD",i,j);
