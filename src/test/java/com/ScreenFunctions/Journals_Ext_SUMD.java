...
public class Journals_Ext_SUMD extends GenericMethods{
	...
	public static void Journals_Ext_SUMD(int i, int j) throws Exception 
    ...
    String Agreement_Name=getData("Agreement_Name","Journals_Ext_SUMD",i,j);

		Dropd_Agreement.sendKeys(Agreement_Name);
		waitForElement(Dropd_BucketID);
		
	    String BucketID=getData("BucketID","Journals_Ext_SUMD",i,j);
		...
		String DebitAmount=getData("DebitAmount","Journals_Ext_SUMD",i,j);

		Edi_DebitAmount.sendKeys(DebitAmount);
		
	    String Description=getData("Description","Journals_Ext_SUMD",i,j);

		Edi_Description.sendKeys(Description);
		
	    String BucketID2=getData("BucketID2","Journals_Ext_SUMD",i,j);
		
		Edi_BucketID2.sendKeys(BucketID2);
	    
	    String Amount2=getData("Amount2","Journals_Ext_SUMD",i,j);
		
		Edi_Amount2.sendKeys(Amount2);
		
	    String Description2=getData("Description2","Journals_Ext_SUMD",i,j);
