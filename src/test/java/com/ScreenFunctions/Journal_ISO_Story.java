...
public class Journal_ISO_Story extends GenericMethods{
	...
	@FindBy(how=How.XPATH,using="//*[@id='BucketID']/option[7]")
	public static WebElement Click_Bucketid;
	...
	@FindBy(how=How.XPATH,using="//*[@id='btnSaveOne']")
	public static WebElement Btn_Save3;
	...
	public static void Journal_ISO_Story() throws Exception 
	{	
...
waitForElement(Click_EntitySearch);
	...
	waitForElement(Click_Bucketid);
	Click_Bucketid.click();
	...
	String DebitAmount=getData("DebitAmount","story1",4);

	Edi_DebitAmount.sendKeys(DebitAmount);
	
    String Description=getData("Description","story1",4);

	Edi_Description.sendKeys(Description);
	
    String BucketID2=getData("BucketID2","story1",4);
	
	Edi_BucketID2.sendKeys(BucketID2);
    
    String Amount3=getData("Amount3","story1",4);
	
	Edi_Amount2.sendKeys(Amount3);
	
    String Description2=getData("Description2","story1",4);
