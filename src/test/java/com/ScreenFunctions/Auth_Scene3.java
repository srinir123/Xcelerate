...
public class Auth_Scene3 extends GenericMethods{
...
//	@FindBy(how=How.XPATH,using="(//*[text()='Dashboard'])[1]")
//	public static WebElement Click_Dashboard;


	public static String taskid1;
	
	public static String taskid2;
	
	public static String taskid3;
	
	public static String taskid4;
	
	public static String taskid5;
	
	public static String OTP;

	
	
	public static void Auth_Scene3() throws Exception   
	{
...
//		     Btn_Loginbtn.click();
		Thread.sleep(14000);
		     ...
		     taskid1= DBConnection2.dbConnect2();
		     
		     
		     
				System.out.println(Auth_Scene3.taskid1);
				
				
				driver.findElement(By.xpath("//td[text()='"+Auth_Scene3.taskid1+"']")).click();
				...
				Click_Dashboard.click();
			     ...
			     taskid2= DBConnection2.dbConnect2();
			     
			   
			     
					System.out.println(Auth_Scene3.taskid2);
					 Thread.sleep(2000);

					driver.findElement(By.xpath("//td[text()='"+Auth_Scene3.taskid2+"']")).click();
					...
					Click_Dashboard.click();
					 ...
					 taskid3= DBConnection1.dbConnect1();
					
				    
				     
						System.out.println(Auth_Scene3.taskid3);
						 Thread.sleep(2000);
						driver.findElement(By.xpath("//td[text()='"+Auth_Scene3.taskid3+"']")).click();
						...
						Click_Dashboard.click();
						 ...
						 taskid4= DBConnection1.dbConnect1();
						
					     
					     
							System.out.println(Auth_Scene3.taskid4);
							 Thread.sleep(2000);

							driver.findElement(By.xpath("//td[text()='"+Auth_Scene3.taskid4+"']")).click();
							...
							Click_Dashboard.click();
							 ...
							 taskid5= DBConnection1.dbConnect1();
							
						   
						     
								System.out.println(Auth_Scene3.taskid5);
								  Thread.sleep(2000);
								driver.findElement(By.xpath("//td[text()='"+Auth_Scene3.taskid5+"']")).click();
