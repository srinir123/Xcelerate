...
public class PaymentImport_SUMD extends GenericMethods{
	...
	public static void PaymentImport_SUMD(int i,int j) throws Exception 
	...
	String Entity_Name=getData("Entity_Name","PaymentImport_SUMD",i,j);
	...
	String Agreement_Name=getData("Agreement_Name","PaymentImport_SUMD",i,j);

    Dropd_Agreement.sendKeys(Agreement_Name);
    
    waitForElement(Dropd_Subacc);
	
    String SubAccount_Name=getData("SubAccount_Name","PaymentImport_SUMD",i,j);

    Dropd_Subacc.sendKeys(SubAccount_Name);

	waitForElement(Dropd_BucketID);
	
	String BucketID=getData("BucketID","PaymentImport_SUMD",i,j);
