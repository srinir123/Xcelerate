...
public class CollPeriodBalances_MCC_Ext_MUMD extends GenericMethods{
	...
	public static void CollPeriodBalances_MCC_Ext_MUMD(int i) throws Exception 
    ...
    String Agreement_Name=getData("Agreement_Name","CollPeriodBalances_MCC_Ext_MUMD",i);

		Dropd_Agreement.sendKeys(Agreement_Name);
		waitForElement(Dropd_BucketID);
		
	    String BucketID=getData("BucketID","CollPeriodBalances_MCC_Ext_MUMD",i);
	    ...
	    String AccountHolder=getData("AccountHolder","CollPeriodBalances_MCC_Ext_MUMD",i);

		Edi_AccountHolder.sendKeys(AccountHolder);
		
	    String AccountNumber=getData("AccountNumber","CollPeriodBalances_MCC_Ext_MUMD",i);

		Edi_AccountNumber.sendKeys(AccountNumber);

		String Branchcode=getData("Branchcode","CollPeriodBalances_MCC_Ext_MUMD",i);

		Edi_Branchcode.sendKeys(Branchcode);

		String BankAccType=getData("BankAccType","CollPeriodBalances_MCC_Ext_MUMD",i);

		Dropd_BankAccType.sendKeys(BankAccType);

		String Amount=getData("Amount","CollPeriodBalances_MCC_Ext_MUMD",i);

		Edi_Amount.sendKeys(Amount);

		String TransRef=getData("TransRef","CollPeriodBalances_MCC_Ext_MUMD",i);

		Edi_TransRef.sendKeys(TransRef);

		String IntRef=getData("IntRef","CollPeriodBalances_MCC_Ext_MUMD",i);
