...
public class Autorization_Recall extends GenericMethods{
	...
	public static void Autorization_Recall() throws Exception 
	{   
		Thread.sleep(3000);
		System.out.println(Recall_Payments.taskid);
		Thread.sleep(4000);
		
		driver.findElement(By.xpath("//td[text()='"+Recall_Payments.taskid+"']")).click();
