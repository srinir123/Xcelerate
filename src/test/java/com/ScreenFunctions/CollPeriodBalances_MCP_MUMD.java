...
public class CollPeriodBalances_MCP_MUMD extends GenericMethods{
	...
	public static void CollPeriodBalances_MCP_MUMD(int i) throws Exception 
	...
	String Entity_Name=getData("Entity_Name","CollPeriodBalances_MCP_MUMD",i);
	...
	String Agreement_Name=getData("Agreement_Name","CollPeriodBalances_MCP_MUMD",i);

	Dropd_Agreement.sendKeys(Agreement_Name);
	
	waitForElement(Dropd_Subacc);
	
    String SubAccount_Name=getData("SubAccount_Name","CollPeriodBalances_MCP_MUMD",i);

    Dropd_Subacc.sendKeys(SubAccount_Name);
	
		waitForElement(Dropd_BucketID);
		
		String BucketID=getData("BucketID","CollPeriodBalances_MCP_MUMD",i);
		...
		String AccountHolder=getData("AccountHolder","CollPeriodBalances_MCP_MUMD",i);

		Edi_AccountHolder.sendKeys(AccountHolder);

		String AccountNumber=getData("AccountNumber","CollPeriodBalances_MCP_MUMD",i);

		Edi_AccountNumber.sendKeys(AccountNumber);
		
		String Branchcode=getData("Branchcode","CollPeriodBalances_MCP_MUMD",i);

		Edi_Branchcode.sendKeys(Branchcode);

		String BankAccType=getData("BankAccType","CollPeriodBalances_MCP_MUMD",i);

		Dropd_BankAccType.sendKeys(BankAccType);
		
		String Amount=getData("Amount","CollPeriodBalances_MCP_MUMD",i);

		Edi_Amount.sendKeys(Amount);
		
		String TransRef=getData("TransRef","CollPeriodBalances_MCP_MUMD",i);

		Edi_TransRef.sendKeys(TransRef);
		
		String IntRefPmtCap=getData("IntRefPmtCap","CollPeriodBalances_MCP_MUMD",i);

		Edi_IntRefPmtCap.sendKeys(IntRefPmtCap);
		
		String Transtype=getData("Transtype","CollPeriodBalances_MCP_MUMD",i);
		...
		String PmtSubtype=getData("PmtSubtype","CollPeriodBalances_MCP_MUMD",i);
