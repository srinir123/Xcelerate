...
public class CollectionImport_SUMD extends GenericMethods{
	...
	public static void CollectionImport_SUMD(int i, int j) throws Exception 
	...
	String Entity_Name=getData("Entity_Name","CollectionImport_SUMD",i,j);
	...
	Click_CollPeriodBalances.click();
	    ...
	    String Agreement_Name=getData("Agreement_Name","CollectionImport_SUMD",i,j);

	    Dropd_Agreement.sendKeys(Agreement_Name);
	    
        waitForElement(Dropd_Subacc);
		
        String SubAccount_Name=getData("SubAccount_Name","CollectionImport_SUMD",i,j);

        Dropd_Subacc.sendKeys(SubAccount_Name);
	
		waitForElement(Dropd_BucketID);
		
		String BucketID=getData("BucketID","CollectionImport_SUMD",i,j);
