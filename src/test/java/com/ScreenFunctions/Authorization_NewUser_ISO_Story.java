...
public class Authorization_NewUser_ISO_Story extends GenericMethods{
...
//	public static String OTP;
	...
	public static void Authorization_NewUser_ISO_Story() throws Exception 
	{   

		Thread.sleep(12000);
		  System.out.println(iso_story.taskid);			
			
		  
		  
				System.out.println(iso_story.taskid);
				driver.findElement(By.xpath("//td[text()='"+iso_story.taskid+"']")).click();
