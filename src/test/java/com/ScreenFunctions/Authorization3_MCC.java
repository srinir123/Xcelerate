...
public class Authorization3_MCC extends GenericMethods{
	...
	public static void Authorization3_MCC() throws Exception 
	{   
		Thread.sleep(3000);
		System.out.println(Authorization2_MCC.taskid);
		Thread.sleep(4000);
		
		driver.findElement(By.xpath("//td[text()='"+Authorization2_MCC.taskid+"']")).click();
