...
public class Authorization2_MCC extends GenericMethods{
	...
	public static void Authorization2_MCC() throws Exception 
	{   
		Thread.sleep(3000);
		System.out.println(Authorization1_MCC.taskid);
		Thread.sleep(4000);
		
		driver.findElement(By.xpath("//td[text()='"+Authorization1_MCC.taskid+"']")).click();
